...
def find_neg_rsi_div(pair,timeframe,ohlc):
    rsis = rsi.RSI()
    ...
    # print(maxima)
    # print(rsiss)
    # plt.scatter(maxima['Date'],maxima['max'],c='r')
    # plt.plot(ohlc.index,ohlc.High)
    # plt.show()
    ...
    return negative_dive
# ohlc = get_data('BNB-USDT', timeframe='15m',limit=50)
# find_neg_rsi_div('BNB-USDT',timeframe='15m',ohlc=ohlc)